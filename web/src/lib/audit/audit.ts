...
export const auditActions: AuditAction[] = [
	...
	"agent.skill_updated",
	"agent.skill_removed",
	"agent.mcp_server_added",
	"agent.mcp_server_updated",
	"agent.mcp_server_removed",
	"agent.mcp_connected",
	"agent.mcp_disconnected",
	"agent.capability_attached",
	"agent.capability_detached",
	"runner.enrolled",
	"runner.revoked",
	"codebase.connected",
...
const actionLabels: Record<AuditAction, string> = {
	...
	"agent.instructions_changed": "Agent instructions changed",
	"agent.scope_changed": "Agent scope changed",
	"agent.skill_added": "Agent skill added",
	"agent.skill_updated": "Agent skill updated",
	"agent.skill_removed": "Agent skill removed",
	"agent.mcp_server_added": "Agent MCP server added",
	"agent.mcp_server_updated": "Agent MCP server updated",
	"agent.mcp_server_removed": "Agent MCP server removed",
	"agent.mcp_connected": "Agent MCP server signed in",
	"agent.mcp_disconnected": "Agent MCP server signed out",
	"agent.capability_attached": "Library item attached to agent",
	"agent.capability_detached": "Library item detached from agent",
