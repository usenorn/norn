...
ALTER TABLE workspace_code_links ADD COLUMN head_sha text NOT NULL DEFAULT '';
...
ALTER TABLE workspace_code_links DROP COLUMN head_sha;

DROP TABLE workspace_check_evidence;

DROP TABLE workspace_issue_checks;
