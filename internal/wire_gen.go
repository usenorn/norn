...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	bulkOperations := bulkoperation.New(bulkAction, repositoryIssue, workflowState, repositoryLabel, repositoryActivity, repositoryMembership, repositoryCycle, cycleScopeChange, jobProducer, gate, serviceAuthorizer, postgresClient)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	bulkOperations := bulkoperation.New(bulkAction, repositoryIssue, workflowState, repositoryLabel, repositoryActivity, repositoryMembership, repositoryCycle, cycleScopeChange, jobProducer, gate, serviceAuthorizer, client)
