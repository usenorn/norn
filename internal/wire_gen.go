...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	intakes := intake2.New(repositoryIntake, inboundMail, repositoryTeam, jobProducer, issues, serviceAuthorizer, postgresClient, configIntake)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	inboundMail := inboundmail.New(epostix)
	configIntake := config.NewIntake(configConfig)
	intakes := intake2.New(repositoryIntake, inboundMail, repositoryTeam, jobProducer, issues, serviceAuthorizer, client, configIntake)
