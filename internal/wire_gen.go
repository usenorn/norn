...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	agents := agent2.New(repositoryAgent, agentSetting, agentProposal, repositoryAccount, repositoryMembership, repositoryProject, projectMember, apiToken, repositoryTeam, repositoryActivity, workflowState, issues, issueComments, issueQuestion, serviceAuthorizer, postgresClient, serviceAudit)
	...
	projects := project2.New(repositoryProject, projectMember, repositoryAgent, projectStatusUpdate, projectLink, repositoryActivity, repositoryAccount, repositoryMembership, notificationEvent, serviceAuthorizer, webhookEmitter, postgresClient)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	projects := project2.New(repositoryProject, projectMember, repositoryAgent, projectStatusUpdate, projectLink, repositoryActivity, repositoryAccount, repositoryMembership, notificationEvent, serviceAuthorizer, webhookEmitter, client)
