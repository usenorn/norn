...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	executions := execution2.New(repositoryExecution, issueDelegation, changeSet, repositoryPreview, executionService, repositoryRunner, repositoryCodebase, repositoryIssue, workflowState, runnerChannel, issues, serviceSourceControl, serviceEvents, serviceAuthorizer, serviceAudit, postgresClient)
	delegations := delegation.New(issueDelegation, repositoryIssue, repositoryAgent, repositoryExecution, repositoryActivity, webhookEmitter, executions, serviceAuthorizer, postgresClient)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	serviceExecutions := execution2.New(repositoryExecution, issueDelegation, changeSet, repositoryPreview, executionService, repositoryRunner, repositoryCodebase, repositoryIssue, workflowState, runnerChannel, issues, serviceSourceControl, serviceEvents, serviceAuthorizer, serviceAudit, client)
