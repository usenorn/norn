...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	serviceChecks := check2.New(repositoryCheck, checkEvidence, repositoryIssue, issueDelegation, codeLink, repositoryActivity, jobProducer, agentProposal, repositoryAgent, serviceAuthorizer, issues, postgresClient, checks)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	serviceChecks := check2.New(repositoryCheck, checkEvidence, repositoryIssue, issueDelegation, codeLink, repositoryActivity, jobProducer, agentProposal, repositoryAgent, serviceAuthorizer, issues, client, checks)
