...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	executions := execution2.New(repositoryExecution, changeSet, repositoryPreview, repositoryRunner, repositoryCodebase, repositoryIssue, workflowState, runnerChannel, issues, serviceEvents, serviceAuthorizer, serviceAudit, postgresClient)
	...
	runnerChannels := runnerchannel2.New(runnerChannel, runnerSession, repositoryRunner, runners, executions, issueQuestions, changeSets, servicePreviews)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	serviceExecutions := execution2.New(repositoryExecution, changeSet, repositoryPreview, repositoryRunner, repositoryCodebase, repositoryIssue, workflowState, runnerChannel, issues, serviceEvents, serviceAuthorizer, serviceAudit, client)
