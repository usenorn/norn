...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	gate := checkgate.New(repositoryCheck, checkEvidence)
	...
	checks := check2.New(repositoryCheck, checkEvidence, repositoryIssue, issueDelegation, codeLink, repositoryActivity, jobProducer, agentProposal, repositoryAgent, serviceAuthorizer, issues, postgresClient)
	...
	mcpserverEdge := mcpserver.New(issues, checks, agents, issueComments, projects, cycles, teams, workspaces, workflowStates, labels, searches, serviceSourceControl, app, mcp)
