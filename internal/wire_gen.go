...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	serviceSourceControl := scm2.NewConnections(scmConnection, scmDelivery, codeLink, issueMirror, scmTeamSetting, workflowState, repositoryAccount, repositoryIssue, repositoryActivity, forges, serviceAuthorizer, serviceAudit, postgresClient, app)
