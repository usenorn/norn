...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	serviceSourceControl := scm2.NewConnections(scmConnection, scmRepository, scmRoute, scmTransitionRule, scmDelivery, codeLink, issueMirror, workflowState, repositoryAccount, repositoryIssue, repositoryActivity, forges, serviceAuthorizer, serviceAudit, postgresClient, app)
	...
	sourceControlSync := scm2.NewSync(scmConnection, scmRepository, scmRoute, scmTransitionRule, scmDelivery, codeLink, issueMirror, workflowState, repositoryIssue, repositoryActivity, repositoryMembership, forges, serviceAuthorizer, issues, issueComments, jobProducer, postgresClient, sourceControl, app)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	gitlabForge := gitlab.New(forgeClient, sourceControl)
	forges := scm2.NewForges(githubForge, gitlabForge)
	sourceControlSync := scm2.NewSync(scmConnection, scmRepository, scmRoute, scmTransitionRule, scmDelivery, codeLink, issueMirror, workflowState, repositoryIssue, repositoryActivity, repositoryMembership, forges, serviceAuthorizer, issues, issueComments, jobProducer, client, sourceControl, app)
