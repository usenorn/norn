...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	inboundMail := inboundmail.New(configIntake)
	intakes := intake2.New(repositoryIntake, inboundMail, repositoryTeam, jobProducer, issues, serviceAuthorizer, configIntake)
	...
	inboundmailEdge := inboundmail2.New(intakes, configIntake)
