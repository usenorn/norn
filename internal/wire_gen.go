...
func InitApp(cfgFile string) (*App, func(), error) {
	...
	executions := execution2.New(repositoryExecution, changeSet, repositoryPreview, executionService, repositoryRunner, repositoryCodebase, repositoryIssue, workflowState, runnerChannel, issues, serviceEvents, serviceAuthorizer, serviceAudit, postgresClient)
...
func InitWorker(cfgFile string) (*Worker, func(), error) {
	...
	serviceExecutions := execution2.New(repositoryExecution, changeSet, repositoryPreview, executionService, repositoryRunner, repositoryCodebase, repositoryIssue, workflowState, runnerChannel, issues, serviceEvents, serviceAuthorizer, serviceAudit, client)
