...
func statements() map[string]string {
	return map[string]string{
		...
		"detachCommentMirrorsQuery":     detachCommentMirrorsQuery,
		"detachLinksQuery":              detachLinksQuery,
		"detachMirrorsQuery":            detachMirrorsQuery,
		"disableSettingQuery":           disableSettingQuery,
		...
		"listMirrorsByConnectionQuery":  listMirrorsByConnectionQuery,
		"listPendingDeliveriesQuery":    listPendingDeliveriesQuery,
		"markAdvancedQuery":             markAdvancedQuery,
		...
		"updateSettingsQuery":           updateSettingsQuery,
		"upsertLinkQuery":               upsertLinkQuery,
		"upsertSettingQuery":            upsertSettingQuery,
	}
}
